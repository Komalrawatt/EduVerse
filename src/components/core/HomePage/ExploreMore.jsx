  ...
  return (
    <div className='flex flex-col items-center my-10 mx-auto'>
        ...
        <div className='text-4xl font-semibold text-center'>
            Unlock the
            <HighlighText text={"Power of Course"}/>
        </div>

        <p className='text-center text-richblack-300 text-[16px] mt-4 font-semibold'>
            Learn to build anything you can imagine
        </p>


        {/* Tabs */}
        <div className='w-fit flex flex-row rounded-full bg-richblack-800 mt-10 px-1 py-1 border-richblack-100'>
            {
