...
const Footer = () => {
  return (
    <div className='bg-richblack-800'>
      ...
      {/* bottom */}
      <div className='w-11/12 max-w-[1260px] mx-auto flex flex-row justify-between items-center flex-wrap text-richblack-400 pb-14 gap-3 '>
          <div className='flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full mt-3'>
