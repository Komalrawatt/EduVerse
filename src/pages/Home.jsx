...
const Home = () => {
  return (
    <div>
      {/* Section1 */}
      <div className='relative mx-auto max-w-[1260px] flex flex-col w-11/12 items-center text-white justift-between '>

        <Link to={"/signup"}>

          <div className=" group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
            transition-all duration-200 hover:scale-95 w-fit">
            <div className='flex flex-row items-center gap-2 rounded-full px-10 py-[5px] hover:bg-richblack-900 '>
      ...
      {/* Section2 */}
      <div className='bg-white text-richblack-500'>
        ...
        <div className='mx-auto max-w-[1260px] flex flex-col items-center justify-between gap-7'>
          <div className='flex flex-row gap-8 justify-center mb-10 mt-[95px]  '>
            <div className='text-4xl font-semibold w-[45%]'>
              Get the Skills you need for a
              <HighlighText text={"Job that is in demand"} />
            </div>

            <div className='flex flex-col gap-10 w-[36%] items-start '>
      ...
      {/* Section3 */}
      <div className="w-11/12 mx-auto max-w-[1260px] flex flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white">
